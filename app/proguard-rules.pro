...
# Allow R8 to change access modifiers and aggressively merge interfaces,
# making the obfuscated output structurally distinct from the legacy build.
-allowaccessmodification
-mergeinterfacesaggressively
# Repackage all obfuscated classes into a single flat package so the released
# dex package structure is distinct from the legacy build (which keeps the
# original hierarchy). Kept classes keep their original names.
-repackageclasses 'com.vz'
-flattenpackagehierarchy 'com.vz'
# Maximize method overloading to further scramble method signatures.
...
-keep public class !com.novexa.platform.core.ui.base.BaseActivity extends android.app.Activity
...
-keep,allowoptimization class com.novexa.platform.core.common.data.bean.** { <fields>; }
-keep,allowoptimization class com.novexa.platform.feature.**.model.** { <fields>; }
-keep,allowoptimization class com.novexa.platform.calculation.model.** { <fields>; }
