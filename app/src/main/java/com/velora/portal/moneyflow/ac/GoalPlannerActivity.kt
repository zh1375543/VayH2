...
import com.velora.portal.databinding.ActivityGoalPlannerBinding
import java.math.BigDecimal
import java.math.RoundingMode

/** Savings calculator with input and analysis states in one activity. */
class GoalPlannerActivity : BaseActivity<ActivityGoalPlannerBinding>() {
    ...
    override fun initObserve() = with(viewModel) {
        savingsCalculationState.observe(this@GoalPlannerActivity) { state ->
            when (state) {
    ...
    companion object {
        ...
        fun launch(context: Context) {
            context.startActivity(Intent(context, GoalPlannerActivity::class.java))
        }
    }
}
