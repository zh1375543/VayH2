...
import com.velora.portal.databinding.FragmentIncomeSnapshotBinding
import com.velora.portal.databinding.ItemIncomeStatCardBinding
...
class IncomeSnapshotFragment : BaseFragment<FragmentIncomeSnapshotBinding>(
    R.layout.fragment_income_snapshot,
) {
    override val binding by viewBinding(FragmentIncomeSnapshotBinding::bind)
    ...
    private fun bindStatCard(
        card: ItemIncomeStatCardBinding,
        iconRes: Int,
        title: CharSequence,
        value: CharSequence,
