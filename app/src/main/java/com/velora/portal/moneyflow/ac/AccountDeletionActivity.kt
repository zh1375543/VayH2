...
import com.velora.portal.databinding.ActivityAccountDeletionBinding
...
class AccountDeletionActivity : BaseActivity<ActivityAccountDeletionBinding>() {

    override val binding by viewBinding(ActivityAccountDeletionBinding::inflate)
    ...
    override fun initView() = with(binding) {
        ...
        tvConfirm.singleClick {
            showConfirmDialog(
                ...
                desc = getString(R.string.delete_account_title),
                okAction = viewModel::signOut,
            )
        }
    }
