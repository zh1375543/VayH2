...
import com.velora.portal.moneyflow.model.BonusType
...
import com.velora.portal.databinding.ActivityRewardPayoutBinding
import java.math.BigDecimal
import java.math.RoundingMode

/** Bonus calculator with input and analysis states in one activity. */
class RewardPayoutActivity : BaseActivity<ActivityRewardPayoutBinding>() {

    override val binding by viewBinding(ActivityRewardPayoutBinding::inflate)
    ...
    override fun initObserve() = with(viewModel) {
        bonusCalculationState.observe(this@RewardPayoutActivity) { state ->
            when (state) {
    ...
    companion object {
        ...
        fun launch(context: Context) {
            context.startActivity(Intent(context, RewardPayoutActivity::class.java))
        }
    }
}
