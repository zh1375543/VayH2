...
import com.velora.portal.moneyflow.model.IncomePeriod
...
import com.velora.portal.databinding.ActivityWithholdingEstimatorBinding
import java.math.BigDecimal
import java.math.RoundingMode

/** Tax calculator with input and analysis states in one activity. */
class WithholdingEstimatorActivity : BaseActivity<ActivityWithholdingEstimatorBinding>() {

    override val binding by viewBinding(ActivityWithholdingEstimatorBinding::inflate)
    ...
    override fun initObserve() = with(viewModel) {
        taxCalculationState.observe(this@WithholdingEstimatorActivity) { state ->
            when (state) {
    ...
    companion object {
        ...
        fun launch(context: Context) {
            context.startActivity(Intent(context, WithholdingEstimatorActivity::class.java))
        }
    }
}
