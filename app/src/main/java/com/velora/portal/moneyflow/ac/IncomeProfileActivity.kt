...
import com.velora.portal.moneyflow.SideHomeRepository
...
import com.velora.portal.platform.telemetry.device.LocationInfoHelper
...
import com.velora.portal.databinding.ActivityIncomeProfileBinding
import kotlinx.coroutines.launch
import java.math.BigDecimal
import java.util.Locale

class IncomeProfileActivity : BaseActivity<ActivityIncomeProfileBinding>() {
    ...
    companion object {
        ...
        fun launch(context: Context) {
            context.startActivity(Intent(context, IncomeProfileActivity::class.java))
        }
    }
}
