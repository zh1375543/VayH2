package com.velora.portal.journey.communication.inbox.model
...
data class InboxPageResponse(
    val total: Int = 0,
    val list: MutableList<InboxMessageRecord>? = null,
) : Parcelable

@Parcelize
data class InboxMessageRecord(
    val id: Long? = null,
