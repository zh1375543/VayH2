...
import com.velora.portal.core.common.data.ACT_clickApply
import com.velora.portal.core.common.data.ACT_clickConfirm
...
import com.velora.portal.feature.catalog.presentation.adapter.ComboAdapter
import com.velora.portal.feature.accounts.presentation.dialog.chooseAccountsDialog
import com.velora.portal.core.ui.extension.resetScale
import com.velora.portal.core.ui.extension.singleClick
import com.velora.portal.feature.catalog.presentation.dialog.showLoanAgreementDialog
import com.velora.portal.core.common.util.loanevent.LoanEvent
import com.velora.portal.core.common.util.loanevent.LoanEventRecorder
import com.velora.portal.core.common.util.ORDER_COMMIT
...
class PlanSelectionActivity : BaseActivity<ActivityOfferBundleBinding>() {
    ...
    private fun render(state: PageLoadState<com.velora.portal.feature.catalog.model.MemberOverviewResponse>) {
    ...
    private fun renderLoanOffer(loan: com.velora.portal.feature.catalog.model.MemberOverviewResponse) {
