...
import com.novexa.platform.databinding.ActivitySavingsGoalTipDetailBinding

class SavingsGoalTipDetailActivity : BaseActivity<ActivitySavingsGoalTipDetailBinding>() {

    override val binding by viewBinding(ActivitySavingsGoalTipDetailBinding::inflate)
    ...
    companion object {
        ...
        fun launch(context: Context) {
            context.startActivity(Intent(context, SavingsGoalTipDetailActivity::class.java))
        }
    }
}
