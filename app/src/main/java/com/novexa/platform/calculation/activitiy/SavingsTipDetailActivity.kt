...
import com.novexa.platform.databinding.ActivitySavingsTipDetailBinding

class SavingsTipDetailActivity : BaseActivity<ActivitySavingsTipDetailBinding>() {

    override val binding by viewBinding(ActivitySavingsTipDetailBinding::inflate)
    ...
    companion object {
        ...
        fun launch(context: Context) {
            context.startActivity(Intent(context, SavingsTipDetailActivity::class.java))
        }
    }
}
