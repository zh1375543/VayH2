...
import com.novexa.platform.core.ui.dialog.showWorkTimePickerDialog
import com.novexa.platform.core.ui.extension.singleClick
import com.novexa.platform.databinding.SidepageWorkHoursCalculatorActivityBinding
import java.math.BigDecimal
import java.math.RoundingMode

/** Work-hours calculator with input and analysis states in one activity. */
class WorkHoursCalculatorActivity : BaseActivity<SidepageWorkHoursCalculatorActivityBinding>() {

    override val binding by viewBinding(SidepageWorkHoursCalculatorActivityBinding::inflate)
    ...
    override fun initObserve() = with(viewModel) {
        workHoursCalculationState.observe(this@WorkHoursCalculatorActivity) { state ->
            when (state) {
        ...
        salaryDataState.observe(this@WorkHoursCalculatorActivity) { state ->
    ...
    companion object {
        ...
        fun launch(context: Context) {
            context.startActivity(Intent(context, WorkHoursCalculatorActivity::class.java))
        }
    }
}
