...
import com.novexa.platform.calculation.model.OvertimeType
...
import com.novexa.platform.databinding.SidepageOvertimeCalculatorActivityBinding
import java.math.BigDecimal
import java.math.RoundingMode

/** Overtime calculator with input and analysis states in one activity. */
class OvertimeCalculatorActivity : BaseActivity<SidepageOvertimeCalculatorActivityBinding>() {

    override val binding by viewBinding(SidepageOvertimeCalculatorActivityBinding::inflate)
    ...
    override fun initObserve() = with(viewModel) {
        overtimeCalculationState.observe(this@OvertimeCalculatorActivity) { state ->
            when (state) {
        ...
        salaryDataState.observe(this@OvertimeCalculatorActivity) { state ->
    ...
    companion object {
        ...
        fun launch(context: Context) {
            context.startActivity(Intent(context, OvertimeCalculatorActivity::class.java))
        }
    }
}
