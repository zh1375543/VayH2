...
import com.novexa.platform.databinding.ActivityDocumentReviewBinding
...
import com.novexa.platform.core.common.data.ACT_uploadBackEnd
import com.novexa.platform.core.common.data.ACT_uploadBackStart
import com.novexa.platform.core.common.data.ACT_uploadFaceEnd
import com.novexa.platform.core.common.data.ACT_uploadFaceStart
import com.novexa.platform.core.common.data.ACT_uploadFrontEnd
import com.novexa.platform.core.common.data.ACT_uploadFrontStart
...
import com.novexa.platform.core.ui.binding.bindImageUrl
import com.novexa.platform.core.common.util.KYC_AADHAAR_BACK_CLICK
import com.novexa.platform.core.common.util.KYC_AADHAAR_FRONT_CLICK
import com.novexa.platform.core.common.util.KYC_INFO_COMMIT
import com.novexa.platform.core.common.util.KYC_INFO_PAGE
import com.novexa.platform.core.common.util.image.ImageProcessor
...
import com.novexa.platform.feature.onboarding.presentation.dialog.showKycCardExampleDialog
import com.novexa.platform.feature.onboarding.presentation.dialog.showKycSelfieExampleDialog
        ...
        documentTypeField.setOnClick {
            personalVm.getEnums { options ->
                ...
                showOptionPickerDialog(
                    ...
                    cardTypes.map { com.novexa.platform.core.common.data.bean.SelectionOption(it.info.orEmpty()) },
                ) { index ->
