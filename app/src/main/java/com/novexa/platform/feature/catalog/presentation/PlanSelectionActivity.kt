...
import com.novexa.platform.feature.catalog.presentation.adapter.ComboAdapter
...
import com.novexa.platform.databinding.ActivityOfferBundleBinding
...
class PlanSelectionActivity : BaseActivity<ActivityOfferBundleBinding>() {
    ...
    private fun render(state: PageLoadState<com.novexa.platform.feature.catalog.model.MemberOverviewResponse>) {
    ...
    private fun renderLoanOffer(loan: com.novexa.platform.feature.catalog.model.MemberOverviewResponse) {
